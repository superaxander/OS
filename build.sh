...
i686-elf-gcc -T link.ld -o build/kernel.bin -ffreestanding -O2 -nostdlib build/kernel.o build/start.o build/system.o build/tty.o build/gdt.o build/idt.o build/isr.o build/irq.o build/vga.o build/graphics.o -lgcc
